...
const products = [
    {
        ...
        description: "Advanced gas flow pulse transmitter for accurate monitoring of various gases",
        specifications: [
    ...
    },
    {
        ...
        modelNumber: "GFT24",
        category: "Transmitters",
        description: "Advanced gas flow pulse transmitter with extended voltage range",
        specifications: [
            { name: "Brand", value: "BRAVE" },
        ...
        downloads: [
            {
                name: "GFT24 Installation Manual",
                type: "PDF",
    ...
    },
    {
        ...
        specifications: [
            ...
            { name: "Usage/Application", value: "HVAC, Green House, Landfill Gas, Mushroom farms, and Industrial" },
            { name: "Precision", value: "± 0.5-1%" },
    ...
    },
    {
        ...
        modelNumber: "HT24",
        category: "Transmitters",
        description: "Combined humidity and temperature transmitter for various applications",
        specifications: [
            { name: "Brand", value: "BRAVE" },
            { name: "Model Number", value: "HT24" },
            { name: "Measurement Unit", value: "Temperature and Humidity" },
            { name: "Usage/Application", value: "For HVAC, Home, Hotel, Hospital, Green House and Industrial" },
